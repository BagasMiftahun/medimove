...
@section('title', 'Service Type | Laundry')
...
@section('content')
    <div class="main-content">
        <div class="page-header">
            <h2 class="header-title">Service Type</h2>
            ...
            <div class="card-body">
                <div class="row m-b-30">
                    ...
                    <div class="col-lg-4 text-right">
                        <button class="btn btn-primary" data-toggle="modal" data-target="#create-service-type">
                    ...
                    <table class="table table-hover e-commerce-table">
                        ...
                        <tbody>
                            @foreach ($types as $key => $type)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-icon btn-hover btn-sm btn-rounded" data-toggle="modal"
                                            data-target="#edit-service-type-{{ $type->id }}">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('service-type.destroy', $type->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                ...
                                <div class="modal fade" id="edit-service-type-{{ $type->id }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('service-type.update', $type->id) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label for="edit-name">Type Name *</label>
                                                        <input type="text" name="name" class="form-control"
                                                            id="name" placeholder="Please input type name"
        ...
        {{-- Create service Type  --}}
        <div class="modal fade" id="create-service-type">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
