                        ...
                        <tbody>
                            @foreach ($payments as $key => $payment)
                                <tr>
                                    ...
                                    <td>Rp {{ number_format($payment->order->total_amount, 0, ',', '.') }}</td>
                                    <td>{{ $payment->payment_date }}</td>
                                    <td>{{ $payment->payment_method }}</td>
                                    <td>
                                        <a href="{{ route('payment.edit', ['payment' => $payment->id]) }}" class="btn btn-icon btn-hover btn-sm btn-rounded">
                                        ...
                                        <button class="btn btn-icon btn-hover btn-sm btn-rounded" data-toggle="modal" data-target="#DeleteCSModal-{{ $payment->id }}">
                                            <i class="anticon anticon-delete"></i>
                                        </button>
                                    </td>
                                </tr>
                                ...
                                <div class="modal fade" id="DeleteCSModal-{{ $payment->id }}" tabindex="-1"
