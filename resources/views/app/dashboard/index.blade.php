            ...
            <div class="card">
                <div class="card-body">
                    <div class="media align-items-center">
                        ...
                        <div class="m-l-15">
                            <h2 class="m-b-0">Rp {{ number_format($totalProfit, 0, ',', '.') }}</h2>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="media align-items-center">
                        ...
                        <div class="m-l-15">
                            <h2 class="m-b-0">{{ number_format($growthPercentage, 2) }}%</h2>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="media align-items-center">
                        ...
                        <div class="m-l-15">
                            <h2 class="m-b-0">{{ $customerCount }}</h2>
                        ...
                        <div class="col-4">
                            <div class="d-flex justify-content-center">
                                <div class="media align-items-center">
                                    ...
                                    <div class="m-l-5">
                                        <h4 class="m-b-0">{{ $returncustomer }}</h4>
                        ...
                        <div class="col-4">
                            <div class="d-flex justify-content-center">
                                <div class="media align-items-center">
                                    ...
                                    <div class="m-l-5">
                                        <h4 class="m-b-0">{{ $othercustomer }}</h4>
